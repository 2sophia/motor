...
| 6  | [events](./events)                           | Hook into every turn the agent takes (`on_event`, `on_log`).             |
| 7  | [concurrency](./concurrency)                 | Fan out N independent runs across N motors with `asyncio.gather`.        |
